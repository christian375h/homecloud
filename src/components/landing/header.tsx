    ...
    <ThemeProvider>
      ...
      <header className="h-screen min-h-screen w-screen bg-white">
        <div
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1735633315995-7cffb5df79ce?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }}
        >
